...
@section('crud-content')
    <form action="{{ route('posts.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input name="category" maxlength="30" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text">
        </div>
        <div class="mb-6">
